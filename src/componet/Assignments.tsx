...
const Assignments = () => {
  ...
  return (
    <section className="relative min-h-screen bg-[#030712] flex flex-col items-center px-4 sm:px-6 md:px-16 py-14 sm:py-20 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-72 h-72 sm:w-96 sm:h-96 bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 h-72 sm:w-96 sm:h-96 bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 w-full max-w-6xl relative z-10">
        {assignments.map((assignment, index) => (
          <div
            key={index}
            className="
              group relative
              bg-[#0a0f1c]/70 backdrop-blur-xl
          ...
          >
            ...
            <div className="relative flex flex-col h-full">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="
                  text-[7px] md:text-[9px] sm:text-[10px]
              ...
              <p className="text-gray-400 text-[11px] sm:text-sm mb-6 grow leading-relaxed">
